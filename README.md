...
- **MCPF:** the public subsidy's present value is scaled by a shadow price λ (deadweight loss shown
  separately).
- **Fare optimization:** NPV-, revenue-, and farebox-target fares, shown as options with snap-to.
...
model, not a discrepancy. For the US-LRT preset at its defaults the widget shows **NPV ≈ −$746.6M,
PV-BCR ≈ 0.69**.
...
|---|---|---|---|---|---|---|
| US LRT baseline | 40k | $1.5B | $38k | −$0.75B | 0.69 | marginal, subsidy-heavy (the anchor preset) |
| Elizabeth Line | 600k | $24B | $40k | +$29.1B | 1.83 | costly but justified by scale + agglomeration |
| Stockholm T-bana | 130k | $3B | $23k | +$5.8B | 2.60 | efficient flagship winner |
| High-cost US | 75k | $6B | $80k | −$6.9B | 0.31 | cost-disease cautionary tale |
| Low-cost intl | 70k | $1.2B | $17k | +$0.70B | 1.37 | cheap and efficient |
